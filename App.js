...
import * as mocks from "./constant/mocks.js";
...
class App extends React.Component {
  ...
  renderHeader() {
    ...
    return (
      <Block flex={0.42} column style={{ paddingHorizontal: 20 }}>
      ...
      <Block row card shadow color="white" style={styles.request}>
        ...
        <Block flex={0.75} column middle>
          ...
          <Text caption semibold>
            {request.age}  •  {request.gender}  •  {request.hopital}  •  {request.time}hrs
          </Text>
        </Block>
      </Block>
    );
    ...
    return (
      <Block flex={0.8} column color="gray2" style={styles.requests}>
        <Block flex={false} row space="between" style={styles.requestsHeader}>
          <Text light>mise a jour</Text>
          <TouchableOpacity activeOpacity={0.8}>
            <Text semibold>Voir tout</Text>
          </TouchableOpacity>
        </Block>
